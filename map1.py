...
choice_alien = [[3, 4, 'sectoid'], [4, 3, 'sectoid'], [4, 5, 'sectoid'], [5, 9, 'sectoid'], [5, 11, 'sectoid'],
                [5, 17, 'sectoid'], [5, 19, 'sectoid'], [16, 21, 'sectoid'],
                [16, 23, 'sectoid']]  # список клятых алиенов
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            if event.button == 1:
                ...
                if s1 != choice_hero2 and hero == 3:
                    if s1 not in s and Move.way(Move(), s, choice_hero2[1], choice_hero2[0], s1[1], s1[0], 9) \
